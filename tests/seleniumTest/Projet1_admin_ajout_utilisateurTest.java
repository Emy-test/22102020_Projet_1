...
//import java.net.URL;
//public class Projet1_admin_ajout_utilisateurTest {
...
//  @Test
//  public void projet1adminajoututilisateur() {
...
//    driver.findElement(By.name("pwd")).sendKeys("selenium");
//    driver.findElement(By.name("nom")).click();
//    driver.findElement(By.name("nom")).sendKeys("selenium");
//    driver.findElement(By.name("role")).click();
//    driver.findElement(By.name("role")).sendKeys("selenium");
//    driver.findElement(By.name("mail")).click();
//    driver.findElement(By.name("mail")).sendKeys("selenium");
