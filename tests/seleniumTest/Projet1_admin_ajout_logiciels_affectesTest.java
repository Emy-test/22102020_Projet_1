...
//import java.net.URL;
//public class Projet1_admin_ajout_logiciels_affectesTest {
...
//  @Test
//  public void projet1adminajoutlogicielsaffectes() {
...
//    driver.findElement(By.cssSelector("tr:nth-child(3) > td:nth-child(6) > nav")).click();
//    //driver.findElement(By.linkText("Ajouter un logiciel affecte")).click();
//    //driver.findElement(By.xpath("//a[contains(@href, '/22102020_Projet_1/ajoutperimetrebulletin.jsp?id=1')]")).click();
//    
//    driver.findElement(By.name("nom")).click();
//    {
//      WebElement dropdown = driver.findElement(By.name("nom"));
//      dropdown.findElement(By.xpath("//option[. = 'Eclipse']")).click();
//    }
//    driver.findElement(By.name("nom")).click();
